...
<head>
    ...
    <title>Customers - Pahana Educational Billing System</title>
            ...
            <main role="main" class="main-content">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
                    ...
                    <div class="btn-toolbar mb-2 mb-md-0">
                        <a href="${pageContext.request.contextPath}/customers/add" class="btn btn-sm btn-primary">
                ...
                <div class="search-box">
                    <form action="${pageContext.request.contextPath}/customers/search" method="post" class="form-inline">
                            ...
                            <c:forEach var="customer" items="${customers}">
                                <tr>
                                    ...
                                    <td class="action-buttons">
                                        ...
                                        <a href="${pageContext.request.contextPath}/bills/generate?accountNumber=${customer.accountNumber}" class="btn btn-sm btn-success">
                                            <i class="fas fa-file-invoice"></i> Bill
                                        </a>
                                        <a href="${pageContext.request.contextPath}/customers/delete?accountNumber=${customer.accountNumber}" class="btn btn-sm btn-danger" 

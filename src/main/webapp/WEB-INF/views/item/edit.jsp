...
<head>
    ...
    <title>Edit Item - Pahana Educational Billing System</title>
        ...
        <div class="row">
            ...
            <main role="main" class="main-content">
                ...
                <div class="form-container">
                    ...
                    <form action="${pageContext.request.contextPath}/items/update" method="post">
                        <input type="hidden" name="itemId" value="${item.itemId}">
                        <div class="form-group">
                            <label for="itemCode">Item Code <span class="text-danger">*</span></label>
                            <input type="text" class="form-control" id="itemCode" name="itemCode" value="${item.itemCode}" readonly>
                            <small class="form-text text-muted">Item code cannot be changed</small>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" class="form-control" id="unitPrice" name="unitPrice" value="${item.unitPrice}" step="0.01" min="0" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="stockQuantity">Stock Quantity <span class="text-danger">*</span></label>
                            <input type="number" class="form-control" id="stockQuantity" name="stockQuantity" value="${item.stockQuantity}" min="0" required>
                        </div>
                        <div class="form-group">
